...
export default function RepaymentPlan({ duration, interestPaymentsStart, interestPaymentsRate, interestRate, interestsDates, endDate }) {
  ...
  const interestsObj = {
    ...
    createPlan() {
      this.calcInterestsDistribution().calcInterestsAmount().createInterests().calcTotalRepayment()
    },
  }
        ...
        {[endDate, ...interestsObj.interests].map((value, i) => {
          const bridgeMarkup = (
            <div class="repayment-plan__bridge-container">
              <svg viewBox="0 0 10 102" class="repayment-plan__bridge" xmlns="http://www.w3.org/2000/svg">
                <line x1="5" y1="102" x2="5" y2="0" class="repayment-plan__line" />
              </svg>
            </div>
          )
            ...
            <div class="repayment-plan__infographic-group">
              ...
              <div class="repayment-plan__node">
                <div class="repayment-plan__center-placeholder">
                  ...
                  <svg viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg" class="repayment-plan__circle-container">
